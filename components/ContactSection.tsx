"use client"; // Adicione se estiver usando Next.js App Router

import { useState } from 'react';

export default function ContactSection() {
  // Estado para capturar os campos do formulário
  ...
  const handleSendWhatsApp = (e: React.FormEvent) => {
    ...
    // Número do primeiro WhatsApp (remova espaços e símbolos)
            ...
            <div className="bg-white/5 backdrop-blur-sm p-10 rounded-sm border border-white/10 flex-grow flex flex-col justify-center relative overflow-hidden">
              ...
              <div className="space-y-10 ml-4">
                <div className="tabular-nums space-y-10">
                  {/* WhatsApps agora são clicáveis via prop 'href' */}
                  <ContactInfo 
                    icon={<WhatsAppIcon />} 
                    label="WhatsApp" 
                    value="+31 687111175" 
                  ...
                  <ContactInfo 
                    ...
                    value="+31 685545494" 
                    isWhatsApp 
                    href="https://wa.me/31685545494" 
                  />
                </div>
                <ContactInfo icon={<MailIcon />} label="E-mail" value="barrosbouw@gmail.com" href="mailto:barrosbouw@gmail.com" />
...
function ContactInfo({ icon, label, value, isWhatsApp = false, href }: any) {
  const content = (
