    ...
    <div className="fixed bottom-6 right-6 flex flex-col items-center gap-2 z-[100]">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="relative group flex items-center">
          <span className="absolute right-full mr-3 bg-black/80 text-white text-[10px] py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none uppercase font-bold tracking-widest">
            BARROS BOUW
          </span>
